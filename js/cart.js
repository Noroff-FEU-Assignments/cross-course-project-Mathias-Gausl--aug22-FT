...
if(removeAssassin !== null){removeAssassin.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart1"), location.reload())})};
if(removeFurious !== null){removeFurious.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart2"), location.reload())})};
if(removeBoxer !== null){removeBoxer.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart3"), location.reload())})};
if(removeForge !== null){removeForge.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart4"), location.reload())})};
if(removeSpace !== null){removeSpace.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart5"), location.reload())})};
if(removeRacing !== null){removeRacing.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart6"), location.reload())})};
if(removecyber !== null){removecyber.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart7"), location.reload())})};
if(removePingpong !== null){removePingpong.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart8"), location.reload())})};
if(removeBlack !== null){removeBlack.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart9"), location.reload())})};
if(removeSuper !== null){removeSuper.addEventListener("click", ()=> {content.pop(localStorage.removeItem("shoppingcart10"), location.reload())})};
